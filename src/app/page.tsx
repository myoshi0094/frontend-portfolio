      ...
      <section className="relative bg-gradient-to-br from-[#0F0F0F] via-[#1A1A1A] to-[#0F0F0F] py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <FadeInWhenVisible delay={0.6} className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeInWhenVisible className="text-center mb-12">
            ...
            <p className="text-lg text-[#A1A1A1]">
              常に新しい技術を学び、最適なツールを選択して開発しています
            </p>
          </FadeInWhenVisible>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <AnimatedCard delay={0.1} className="bg-[#1F1F1F] border border-gray-700/50 rounded-lg p-6 hover:border-white/50 transition-all duration-300 group">
            ...
            <AnimatedCard delay={0.2} className="bg-[#1F1F1F] border border-gray-700/50 rounded-lg p-6 hover:border-white/50 transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-white transition-colors">デザイン</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
            ...
            <AnimatedCard delay={0.3} className="bg-[#1F1F1F] border border-gray-700/50 rounded-lg p-6 hover:border-white/50 transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-white transition-colors">バックエンド</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-[#A1A1A1] rounded-full shadow-lg shadow-white/20"></div>
          ...
          {latestPosts.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              {latestPosts.map((post, index) => (
                <AnimatedCard key={post.id} delay={index * 0.1} className="bg-[#1F1F1F] border border-gray-700/50 rounded-lg p-6 hover:border-white/50 transition-all duration-300 group">
